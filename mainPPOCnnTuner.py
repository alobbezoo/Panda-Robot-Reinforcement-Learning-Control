"""
Goal of this script is to search the space of hyperaparameters for a Panda Reach PPO model. 
...
# Custom Imports
from SB3.PPO.optimizePPOCnnDense import TrainOpt
from SB3.PPO.exploreOptunaPPOCnnDense import OptunaFunc
...
#Training Constants
N_TRIALS = 2 #200 #NOTE: Check and Update Me
N_STARTUP_TRIALS = 8
N_TIMESTEPS = 1e4 #1e5 #NOTE: Check and Update Me
EVAL_FREQ = 1e3
N_EVAL_EPISODES = 10
RENDER = False
VERBOSE = 1
...
OPTIMIZED_N_TIMESTEPS = 2e4 #6e6 #NOTE: Check and Update Me
...
if __name__ == "__main__":
    ...
    try:
        OptimizedStudy = TrainOpt(modelHomeDir = modelHomeDir, callbackDir = optimizedCallbackDir, trial=trial, env_ID=ENV_ID, timeSteps=OPTIMIZED_N_TIMESTEPS, 
            verbose=VERBOSE, render=RENDER, device=DEVICE)
    ...
    OptimizedStudy.record_video(video_length=400, prefix='ppo-PandaReach')
