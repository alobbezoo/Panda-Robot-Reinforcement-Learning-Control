...
# APRIL 25, 2022: CHANGED GRIPPER FORCE TO 250 TO PREVENT DROPPING (LINE 38) AND CHANGED SPINNING FRICTION 
# TO 1.0 (LINE 48)
...
class Panda(PyBulletRobot):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            joint_forces=np.array([87.0, 87.0, 87.0, 87.0, 12.0, 120.0, 120.0, 250.0, 250.0]),
            # APRIL 25, 2022: CHANGED GRIPPER FORCE TO 250 TO PREVENT DROPPING 
        )
        ...
        self.sim.set_spinning_friction(self.body_name, self.fingers_indices[0], spinning_friction=1.0)
        self.sim.set_spinning_friction(self.body_name, self.fingers_indices[1], spinning_friction=1.0)
        # APRIL 25, 2022: CHANGED SPINNING FRICTION TO 1.0
