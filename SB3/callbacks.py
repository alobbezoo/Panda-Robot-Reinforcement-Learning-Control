...
class TrialEvalCallbackNOptuna(EvalCallback):
    """Callback used for evaluating and reporting a trial."""
    ...
    def _on_step(self) -> bool:
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            print("(mean_reward, self.eval_idx): ", mean_reward, self.eval_idx)

        return True


class EvalCallbackCust(EvalCallback):
    """
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            if self.log_path is not None:
                ...
                x, y = results_plotter.ts2xy(results_plotter.load_results(self.log_path), 'timesteps')
