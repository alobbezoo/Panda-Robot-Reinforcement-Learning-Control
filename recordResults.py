...
# MODELPATH = "/home/hjkwon/Documents/Panda-Robot-RL-Control-with-RGBD-Sensor/cnnTraining/2022-07-13/SACCNNReach/callback/best_model.zip"
...
nameDir3 = nameDir2 + POLICYNAME + "unconverged2/"
...
record_video_multiple(model=loaded_model, n_envs = n_envs, env_id=ENV_ID, video_length = 50, video_dir=vidDir, \
