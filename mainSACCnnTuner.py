"""
Goal of this script is to search the space of hyperaparameters for a Panda Reach SAC model. 
...
# Custom Imports
from SB3.SAC.optimizeSACCNNDense import TrainOpt
from SB3.SAC.exploreOptunaSACCnnDense import OptunaFunc
...
#Training Constants
N_TRIALS = 50 #5 #NOTE: Check and Update Me
N_STARTUP_TRIALS = 5
...
if __name__ == "__main__":
    ...
    pruner = MedianPruner(n_startup_trials=N_STARTUP_TRIALS, n_warmup_steps=10) #int(15000))
    ...
    OptimizedStudy.record_video(video_length=400, prefix='SAC-PandaReach')
